-- Drop and recreate the get_teacher_unlocked_chapters function to include chapter_number
DROP FUNCTION IF EXISTS public.get_teacher_unlocked_chapters(uuid);
...
AS $function$
  ...
  ORDER BY grade_name, subject_name, chapter_number;
$function$;